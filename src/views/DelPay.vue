          ...
          <div class="variants__element">
            <div class=" variants__element-pickup">
              <div class="variants__element-wrapper">
                ...
                <p class="variants__element-description">Для жителей Харькова есть возможность забрать заказ в нашем
                магазине по адресу: ул. Героев труда 7, ТРЦ Караван.<br><br>
          ...
          <div class="variants__element">
            <div class="variants__element-kharkiv">
              <div class="variants__element-wrapper">
                ...
                <p class="variants__element-description">Доставка товара по Харькову может быть осуществлена по
                указанному адресу на необходимую дату.<br><br>
          ...
          <div class="variants__element">
            <div class="variants__element-ukraine">
              <div class="variants__element-wrapper">
                ...
                <p class="variants__element-description">Отправляем через Новую почту. Стоимость отправки зависит от
                веса посылки и города.<br><br>
                  Заказ высылается в течение 24-х часов после выполнения.<br><br>
                  Вы можете оплатить товар при получении наложенным платежом или произвести предоплату на карту банка.
                </p><br>
              </div>
            </div>
          </div>
