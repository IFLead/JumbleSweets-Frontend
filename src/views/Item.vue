				...
				<b-row>
					<b-col cols="12">
						<a href="#" class="characteristics__link">
							<span>
								<svg class="characteristics__link--icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						...
						<div class="information__content">
							...
							<div class="information__buttons">
								<el-button class="information__button"><p>Добавить в корзину</p>
									<span>
										<svg class="information__button--icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							...
							<b-row>
								<b-col md="4" class="item-advantages__element">
									<div class="item-advantages__photo item-advantages__photo--car">
										<svg class="icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 355.276 355.276" style="enable-background:new 0 0 355.276 355.276;"
											xml:space="preserve">
										<g>
											<g>
