		...
		<header class="main-header">
			<b-container>
              ...
              <router-link to="/" class="main-header__logo"></router-link>
							...
							<div class="main-header__menu menu" :class="{show: menuOpen}">
								<ul class="menu__list">
									<li class="menu__cart">
										<el-badge :value="1">
                    ...
                    <router-link to="#" class="mobile__inst">
											<span>
												<svg class="icon" id="instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
													...
													<g id="Group_391" data-name="Group 391" transform="translate(29.418 7.918)">
														<g id="Group_390" data-name="Group 390">
															<circle style="fill #ffffff;" id="Ellipse_10" data-name="Ellipse 10" cx="1.332" cy="1.332" r="1.332"/>
														</g>
													</g>
												</svg>
