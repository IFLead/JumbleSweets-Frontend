    ...
    <main>
                ...
                <el-carousel-item>
                  <div class="description__wrapper">
                    ...
                    <p class="description__text">
                      Доставляем самые разные сладости и напитки из Европы, Азии и США прямо к Вам
                      домой.
                    </p>
                    <p class="description__text">
                      Мы с удовольствием соберём для Вас стильный бокс сладостей, который станет
                      вкусным и необычным
            ...
            <b-col>
              <div class="sale__content">
                <div class="sale__wrapper">
                  ...
                  <p class="sale__description">Используй промокод <span
                    class="special">JUMBLESALE2018</span> при
                    оформлении заказа. Акция действует до <span class="sale__date">31 декабря 2018 года.</span>
                  </p>
                </div>
              </div>
            </b-col>
              ...
              <el-collapse v-model="activeNames">
                <div class="filter__content">
                  ...
                  <el-collapse-item title="Производитель" name="2">
                    <ul v-for="manufacturer in allManufacturers" :key="manufacturer.id"
                        class="filter__list filter__list--manufacture">
                      <li>
                  ...
                  <el-collapse-item title="Поводы" name="3">
                    <ul v-for="occasion in allOccasions" :key="occasion.id"
                        class="filter__list filter__list--occasion">
                      <li>
                  ...
                  <div class="catalog__content">
                    ...
                    <div class="catalog__information">
                      ...
                      <div class="catalog__like">
                        <div v-if="product.node.favourite" @click="likeProduct(product.node, liked=false)">
                        ...
                        <div v-else @click="likeProduct(product.node, liked=true)">
                          <svg id="Capa_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <section v-if="this.$JUMBLE_BOX_ENABLED" class="jumble">
        <b-container>
          <b-row>
            <b-col>
              <div class="jumble__content">
                <div class="jumble__wrapper">
                  <b class="jumble__title">Jumble Box - это всегда позитивные эмоции.</b>
                  <p class="jumble__description">У нас можно заказать Jumble Box к любому значимому
                  событию. Он станет
                  отличным подарком для Вашей второй половинки, друга или коллеги по работе.</p>
                  <p class="jumble__description">Jumble Box можно заказать в любом оформлении и
                  наполнении. Каждый
                  Jumble Box создаётся в соответствии с Вашими пожеланиями и исключительно в
                  оригинальном стиле.</p>
              ...
              <div class="advantages__content">
                ...
                <ul class="advantages__list">
                  ...
                  <li class="advantages__element advantages__element--orders">
                    ...
                    <p class="advantages__description">Мы ценим Ваше время и понимаем, с каким
                    волнением Вы ждёте товар,
                    поэтому все заказы обрабатываются максимально быстро.</p>
                  </li>
                  <li class="advantages__element advantages__element--delivery">
                    ...
                    <p class="advantages__description">Если доставка осуществляется по Харькову, Вы
                    платите только при
                    получении товара<br> В случае, если Вы проживаете в другом регионе Украины,
                    доставка происходит
                    Новой почтой посредством предоплаты или наложенного платежа.</p>
                  </li>
                </ul>
              </div>
            </b-col>
...
<style lang="sass">
  ...
  .home
    ...
    .category
      ...
      &__element
        margin:
          bottom: 30px
        &:hover
          .category__element-candybar, .category__element-marmalade, .category__element-drinks, .category__element-chocolate
        ...
        &-candybar
          background-image: url("../assets/candy-bar-1735659_1920.jpg")
        &-marmalade
          background-image: url("../assets/marmalade-1248343_1920.jpg")
        &-drinks
          background-image: url("../assets/drew-taylor-325456-unsplash.jpg")
        &-chocolate
          background-image: url("../assets/candies-chocolates-delicious-867464.jpg")
    ...
    .sale
      ...
      &__content
        position: relative
        background-image: url("../assets/annie-spratt-96529-unsplash.jpg")
        background-repeat: no-repeat
        background-size: cover
    ...
    .jumble
      ...
      .jumble__button
        padding:
          right: 62px
        background-image: url("../assets/Icons/tool.svg")
        background-repeat: no-repeat
    ...
    .advantages
      ...
      &__content
        padding:
          ...
          bottom: 1px
        background-color: grey
        background-image: url("../assets/candies-confection-delicious-884509.jpg")
        background-size: cover
      ...
      &__element
        ...
        &--orders
          background-image: url("../assets/Icons/fast.svg")
          background-position: 0 -5px
        &--delivery
          background-image: url("../assets/Icons/delivery-box.svg")
        @media (max-width: 991.98px)
          margin:
            bottom: 40px
        @media (max-width: 767.98px)
    ...
    .delivery
      ...
      &__content
        ...
        background-color: #000000
        color: #ffffff
        background-image: url("../assets/anton-sharov-423618-unsplash.jpg")
        background-repeat: no-repeat
        background-size: cover
